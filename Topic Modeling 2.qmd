...
Set the data, load necessary packages.
...
movies<- read.csv("C:/Users/16597/Downloads/movie_plots.csv", stringsAsFactors = FALSE)
# Clean the words
movies<- movies%>% filter(!is.na(Plot))

```

Next step is creating the Document-type Matrix.
...
Making word cloud. The amount of words is large, so I just keep the top 10 words.
